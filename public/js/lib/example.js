...
function createChina() {
    map1 = null;
    bmap = new BMap.Map("map");    // 创建Map实例
    bmap.centerAndZoom(new BMap.Point(104.403119+18, 38.028658), 5);  // 初始化地图,设置中心点坐标和地图级别
    //添加地图类型控件
        ...
        *      这样就做出了一个经过多次西北角的闭合多边形*/
        ...
        var plyall = new BMap.Polygon(pArray,
                { strokeOpacity: 1, strokeColor: "#091934",
                    strokeWeight: 1, fillColor: "#000c4d",fillOpacity: 1 }); //建立多边形覆盖物
